...
class IsBarcodeFormatValidTests(TestCase):
    def test_is_barcode_format_valid(self):
        ...
        self.assertTrue(is_barcode_format_valid("CP159600101"))
        self.assertTrue(is_barcode_format_valid("CP158600001"))
        ...
        self.assertTrue(is_barcode_format_valid("CP999T99101"))
        self.assertTrue(is_barcode_format_valid("CP998T99001"))
