...
def reassign_tokens(modeladmin, request, queryset):
    ...
    for user in queryset:
        user.assign_token()
    reassign_tokens.short_description = "Reassign authentication tokens for selected users" # noqa: E501, E261
...
class UserForm(forms.ModelForm):
    ...
    def clean_password(self):
        # even though there is no way to change the password, we are still overriding
        # the possible changed value with original value.
