...
TB_STUDY_A_MAX_COUNT = 1250
TB_STUDY_B_MAX_COUNT = 1250
TB_STUDY_C_MAX_COUNT = 15000

TB_STUDY_A_END_DATE = env.str("MQR_STUDY_START_DATE", "2023-11-16")
TB_STUDY_B_END_DATE = env.str("MQR_STUDY_START_DATE", "2023-11-16")
TB_STUDY_C_END_DATE = env.str("MQR_STUDY_START_DATE", "2023-12-16")
